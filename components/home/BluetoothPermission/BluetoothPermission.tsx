...
const BluetoothPermission = ({ visible, onClose }: BluetoothProps) => {
  const openSettings = () => {
    if (Platform.OS === "ios") {
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerContent}>
              <Text style={styles.titleText}>Bluetooth icazəsi lazımdır</Text>
              <Text style={styles.subTitleText}>
                Cihazı əlavə etmək üçün Bluetooth-u aktiv edin. Cihazı tapmaq və
                qoşulmanı avtomatik etmək üçün istifadə olunur.
              </Text>
            </View>
            <TouchableOpacity
